...
public class KeyGenerator {
    ...
    public String generateKey(DbAndTableEnum targetEnum, String relatedRouteId) {
        ...
        /** 2.id数据库索引位*/
        Map<String, String> dbIndexAndTbIndexMap = this.getDbIndexAndTbIndexMap(targetEnum, relatedRouteId);
        String dbIndex = dbIndexAndTbIndexMap.get("dbIndex");
        /** 3.id表索引位*/
        String tbIndex = dbIndexAndTbIndexMap.get("tbIndex");
        /** 4.id规则版本位*/
