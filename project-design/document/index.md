...
3. 常用的库
   ...
   6. OSHI - 一款为 Java 语言提供的基于 JNA 的（本机）操作系统和硬件信息库

   7. Hutool -  一个非常实用的 Java 工具类库，对文件、流、加密解密、转码、正则、线程、XML 等 JDK 方法进行了封装。

   8. Guava

      Guava工程包含了若干被Google的 Java项目广泛依赖 的核心库，例如：集合 [collections] 、缓存 [caching] 、原生类型支持 [primitives support] 、并发库 [concurrency libraries] 、通用注解 [common annotations] 、字符串处理 [string processing] 、I/O 等等。

   9. MapStruct - Java 实体映射工具
...
11. Commons BeanUtils
   ...
   32. Commons Primitives
   
       - 提供了一个更小、更快和更易使用的对 Java 基本类型的支持。
   
   33. Commons Validator
