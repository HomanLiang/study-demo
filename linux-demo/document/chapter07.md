...
![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125607.png)

以上所示，比如有两个工作账户 jianshe 和 cxuan，jianshe 想要使用 cxuan 账户下的 A 目录，那么它可能会输入 `/usr/cxuan/A`，这是一种未使用链接之后的图。

使用链接后的示意如下

![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125634.png)
...
![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125644.png)

两个文件系统分别在不同的磁盘中，彼此保持独立。

而在 Linux 中，是支持`挂载`的，它允许一个磁盘挂在到另外一个磁盘上，那么上面的关系会变成下面这样

![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125659.png)
...
![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125706.png)

如上图所示，A 的共享锁在第四字节到第八字节进行加锁

![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125712.png)

如上图所示，进程在 A 和 B 上同时加了共享锁，其中 6 - 8 字节是重叠锁

![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125717.png)
...
![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125726.png)
...
![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125740.png)
...
![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125749.png)
...
![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125754.png)
...
![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125802.png)
...
![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125810.png)
...
![img](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/linux-demo/20210411125819.png)
