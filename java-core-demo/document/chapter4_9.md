...
![20210102230708](https://homan-blog.oss-cn-beijing.aliyuncs.com/study-demo/java-core-demo/20210322225236.png)
...
假设此时有很多个线程同时调用 `fibonacci()` 方法来生成斐波那契数列，**对于方法中的局部变量result，会不会存在线程安全的问题呢？答案是：不会！！**
