...
> 说明：
>
> 通过上一节对于元注解 [`@Target`](https://github.com/dunwu/javacore/blob/master/docs/basics/java-annotation.md#target)、[`@Retention`](https://github.com/dunwu/javacore/blob/master/docs/basics/java-annotation.md#retention)、[`@Documented`](https://github.com/dunwu/javacore/blob/master/docs/basics/java-annotation.md#documented) 的说明，这里就很容易理解了。
>
