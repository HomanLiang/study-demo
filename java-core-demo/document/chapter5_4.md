...
OSI（Open System Interconnect），即开放式系统互联。 一般都叫OSI参考模型，是ISO（国际标准化组织）组织在1985年研究的网络互连[模型。](https://links.jianshu.com/go?to=http%3A%2F%2Fbaike.baidu.com%2Fview%2F1359266.htm)
