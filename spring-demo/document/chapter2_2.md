...
# Spring Boot 项目构建
## 用 Spring Initializer 构建第一个 Spring Boot 应用
...
1.下载Spring Boot CLI工具包，将其解压到（E:\StudyData\Frame\springcloud），然后配置环境变量：
...
在spring-1.5.8.RELEASE根目录下创建一个HelloWorld.groovy文件；如下图：
